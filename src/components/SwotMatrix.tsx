...
// FIX: Changed import to bring in SwotCategory as a value, not just a type, to fix usage error.
...
const quadrantConfig = {
    strengths: { title: 'Strengths', color: 'border-green-400', textColor: 'text-green-400' },
    weaknesses: { title: 'Weaknesses', color: 'border-yellow-400', textColor: 'text-yellow-400' },
    opportunities: { title: 'Opportunities', color: 'border-blue-400', textColor: 'text-blue-400' },
    threats: { title: 'Threats', color: 'border-red-400', textColor: 'text-red-400' },
};
