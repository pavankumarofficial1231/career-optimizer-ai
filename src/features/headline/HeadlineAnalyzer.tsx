...
const InitialStateDisplay: React.FC = () => (
    <div className="text-center py-8 px-4 border-2 border-dashed border-slate-700 rounded-lg">
        ...
        <h3 className="text-lg font-semibold text-slate-400">Ready to Optimize?</h3>
        <p className="text-slate-500">
            Enter your headline and an optional job description, then click "Analyze Headline" to get AI-powered feedback and suggestions.
        </p>
    </div>
);
