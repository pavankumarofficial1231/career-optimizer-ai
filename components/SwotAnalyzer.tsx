...
import type { SwotAnalysis, LoadingState, SwotCategory } from '../types';
...
const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.25A6.01 6.01 0 0012 1.5a6.01 6.01 0 00-1.5 11.25m1.5 11.25a6.01 6.01 0 01-1.5 11.25m-1.5-11.25a6.01 6.01 0 011.5 11.25m0-11.25V21m-3.75-6.75h7.5" />
    </svg>
);
...
const ActionableRecommendations: React.FC<{ recommendations: SwotAnalysis['recommendations'] }> = ({ recommendations }) => {
    const recConfig = {
        ...
        threats: { title: 'Mitigate Threats', color: 'border-red-400', textColor: 'text-red-400', Icon: ShieldCheckIcon },
    };
